...
namespace Microsoft.AspNetCore.Blazor.Routing
{
    public class RoutingTests
    {
        ...
        public void Parse_SingleLiteral()
        {
            ...
            // Act
            var actual = Routing.ParseTemplate("awesome");
        ...
        public void Parse_SingleParameter()
        {
            ...
            // Act
            var actual = Routing.ParseTemplate(template);
        ...
        public void InvalidTemplate_WithRepeatedParameter()
        {
            var ex = Assert.Throws<InvalidOperationException>(
                () => Routing.ParseTemplate("{p1}/literal/{p1}"));
        ...
        {
            var ex = Assert.Throws<InvalidOperationException>(
                () => Routing.ParseTemplate(template));
        ...
        {
            // Act & Assert
            var ex = Assert.Throws<InvalidOperationException>(() => Routing.ParseTemplate(template));
        ...
        {
            var ex = Assert.Throws<InvalidOperationException>(() => Routing.ParseTemplate("{a}/{}/{z}"));
        ...
        {
            // Arrange & Act
            var parameters = Routing.MatchRoute("/", "/");
        ...
        private class ExpectedTemplateBuilder
        {
            ...
            public RouteTemplate Build() => new RouteTemplate(Segments.ToArray());
