...
export interface Platform {
  ...
  invokeDotNetMethod<T>(methodOptions: MethodOptions, methodArguments: any []) : T | null;
  invokeDotNetMethodAsync<T>(methodOptions: MethodOptions, methodArguments: any[]): Promise<T | null>
