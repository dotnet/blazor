...
namespace Microsoft.AspNetCore.Blazor.Build.Analyzers
{
    ...
    public class ComponentParametersShouldNotBePublicAnalyzer : DiagnosticAnalyzer
    {
        ...
        private void AnalyzeSyntax(SyntaxNodeAnalysisContext context)
        {
            ...
            var parameterAttribute = declaration.AttributeLists
                ...
                .Where(attr => semanticModel.GetTypeInfo(attr).Type?.ToDisplayString() == "Microsoft.AspNetCore.Blazor.ParameterAttribute")
                .FirstOrDefault();
